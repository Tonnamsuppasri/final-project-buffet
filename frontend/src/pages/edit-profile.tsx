          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-4 w-full md:w-auto">
              <button 
                ...
                className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors shrink-0"
              >
              ...
              <div className="text-left">
                ...
                <p className="text-gray-200 mt-1 text-sm sm:text-base">จัดการข้อมูลบัญชีของคุณ</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <button
                  type="button"
                  onClick={handleImageClick}
                  className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors flex items-center space-x-2 text-sm sm:text-base"
                >
            ...
            <div className="bg-gray-50 rounded-xl p-6 border">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-base"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all text-base"
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 pb-8"> {/* เพิ่ม padding bottom สำหรับมือถือ */}
              <button
                type="submit"
                disabled={isLoading}
                className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-102 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center text-base sm:text-lg shadow-md"
              >
                {isLoading ? (
                  <>
              ...
              <button
                type="button"
                onClick={handleGoBack}
                className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 text-base sm:text-lg shadow-md"
              >
                ยกเลิก
              </button>
            </div>
